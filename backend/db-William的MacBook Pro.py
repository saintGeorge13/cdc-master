...
if __name__ == "__main__":
    ...
    test = database()
    # 提取数据
    # print(test.barchart('someday', '2020-05-20', 'China'))
    print(test.linechart('someday', '2020-05-28', 'China', '广东', '广州'))
    ...
    # test.request_for_csv({"date": "2020-05-22", "area": {"country": "China", "province": "guangdong"},"data_type": ["confirmed", "cured"], "level": True}, '123')